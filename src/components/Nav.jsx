...
+254-705764291</button>
                 <Link to="/Booking">  <button className="bg-blue-600 rounded-full py-3 px-4 text-white hover:bg-green-400  transition duration-700 ease-in">Book Now</button></Link> 
                </div>
            </div>
        </div>
      </div>
