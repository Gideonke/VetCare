...
function Services(){
 ...
 <div className=" flex gap-12 justify-center bg-green-50 ">
    <div className="w-[400px] h-[50vh] bg-white mt-20 flex flex-col items-center justify-center gap-4 rounded-2xl group">
        ...
        <div><Link to="/booking"><button className="hidden group-hover:block bg-blue-600 rounded-full py-1 px-2 text-white hover:bg-green-400  transition duration-700 ease-in">Book Now</button></Link></div>
