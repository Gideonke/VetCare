...
function Booknow() {
    ...
    const sendEmail = () => {
        emailjs
            .sendForm('service_om0lnva', 'template_trgu13n', formRef.current, {
                publicKey: 'e1VqdKL0DxMHcQYwc',
    })
            .then(
                () => {
            ...
            <div>
                ...
                <div className="w-[800px] h-[auto] bg-white rounded-2xl flex flex-col gap-[8em] items-center border border-blue-600">
                    ...
                    <form onSubmit={handleSubmit} ref={formRef}>
                        ...
                        <button  onClick={handleChange} className="bg-blue-600 text-white py-3 px-8 rounded-full text-2xl mb-8">REQUEST</button>
                        
                    </form>
                </div>
            </div>
            <div>
                <img src="src/assets/images/pexels-flowerstofox-1870302-removebg-preview.png" width={500} className="mt-[-15%]" alt="Pet Care" />
            </div>
        </div>
    );
}
